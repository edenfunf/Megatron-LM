...
import math
import random
from typing import TYPE_CHECKING, Protocol, Sequence, TypeVar, cast
...
def get_fault(config: "FaultInjectorConfig"):
    ...
    fault_types = config.fault_injector_fault_types
    fault_probabilities = config.fault_injector_fault_probabilities
    assert fault_types is not None, "fault_injector_fault_types must be specified"
